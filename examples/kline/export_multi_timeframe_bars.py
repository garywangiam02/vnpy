...
# 从bar_data/tdx/获取历史1分钟记录，推送至line_bar，输出多周期K线
...
class test_strategy(object):
    ...
    def __init__(self):
        ...
        self.price_tick = 0.5
        self.underlying_symbol = 'J99'
        self.vt_symbol = 'J99.DCE'
    ...
    def createM15(self):
        ...
        self.lineM15.export_filename = os.path.abspath(
            os.path.join(os.getcwd(),
                         u'export/export_{}_{}.csv'.format(self.vt_symbol, self.lineM15.name)))
        ...
        self.lineM15.export_bi_filename = os.path.abspath(
            os.path.join(os.getcwd(),
                         u'export/{}_{}_bi.csv'.format(self.strategy_name, self.lineM15.name)))
        # 输出缠论的笔中枢
        self.lineM15.export_zs_filename = os.path.abspath(
            os.path.join(os.getcwd(),
                         u'export/{}_{}_zs.csv'.format(self.strategy_name, self.lineM15.name)))
        # 输出缠论的段
        self.lineM15.export_duan_filename = os.path.abspath(
            os.path.join(os.getcwd(),
                         u'export/{}_{}_duan.csv'.format(self.strategy_name, self.lineM15.name)))
    ...
    def createlineM30_with_macd(self):
        ...
        self.lineM30.export_filename = os.path.abspath(
            os.path.join(os.getcwd(),
                         u'export/export_{}_{}.csv'.format(self.vt_symbol, self.lineM30.name)))
    ...
    def saveData(self):
        ...
        if len(self.save_m30_bars) > 0:
            outputFile = 'export/{}_m30.csv'.format(self.vt_symbol)
        ...
        if len(self.save_h1_bars) > 0:
            outputFile = 'export/{}_h1.csv'.format(self.vt_symbol)
            with open(outputFile, 'w', encoding='utf8', newline='') as f:
                fieldnames = ['datetime', 'open', 'high', 'low', 'close', 'turnover', 'volume', 'open_interest',
                              'bd_fast', 'bd_slow']
        ...
        if len(self.save_h2_bars) > 0:
            outputFile = 'export/{}_h2.csv'.format(self.vt_symbol)
            with open(outputFile, 'w', encoding='utf8', newline='') as f:
                fieldnames = ['datetime', 'open', 'high', 'low', 'close', 'turnover', 'volume', 'open_interest',
                              'ma5', 'ma10', 'ma18', 'sk', 'sd']
                writer = csv.DictWriter(f=f, fieldnames=fieldnames, dialect='excel')
        ...
        if len(self.save_d_bars) > 0:
            outputFile = 'export/{}_d.csv'.format(self.vt_symbol)
            with open(outputFile, 'w', encoding='utf8', newline='') as f:
                fieldnames = ['datetime', 'open', 'high', 'low', 'close', 'turnover', 'volume', 'open_interest',
                              'bd_fast', 'bd_slow']
                              #'ma5', 'ma10', 'ma18', 'sk', 'sd']
        ...
        if len(self.save_w_bars) > 0:
            outputFile = 'export/{}_w.csv'.format(self.vt_symbol)
            with open(outputFile, 'w', encoding='utf8', newline='') as f:
                fieldnames = ['datetime', 'open', 'high', 'low', 'close', 'turnover', 'volume', 'open_interest',
                              'ma5', 'ma10', 'ma18', 'sk', 'sd']
                writer = csv.DictWriter(f=f, fieldnames=fieldnames, dialect='excel')
...
if __name__ == '__main__':
    ...
    filename = os.path.abspath(os.path.join(vnpy_root, 'bar_data/tdx/{}_20160101_1m.csv'.format(symbol)))
