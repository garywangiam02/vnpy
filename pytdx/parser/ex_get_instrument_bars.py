    ...
    def parseResponse(self, body_buf):
        ...
        for i in range(ret_count):
            try:
                ...
                unpack_buf =body_buf[pos: pos+28]
                if len(unpack_buf)< 28:
                    break
                (open_price, high, low, close, position, trade, price) = struct.unpack("<ffffIIf", unpack_buf)
                ...
                print('parseResponse exception:{}'.format(str(ex)))
