...
# ===导入数据
df = pd.read_hdf('/Users/xingbuxingx/Desktop/股票量化课程/xbx_stock_2019/data/择时策略-回测/signals.h5', key='df')
...
# ===将数据存入hdf文件中
df.to_hdf('/Users/xingbuxingx/Desktop/股票量化课程/xbx_stock_2019/data/择时策略-回测/pos.h5', key='df', mode='w')
