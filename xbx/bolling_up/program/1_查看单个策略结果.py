...
from xbx.bolling_up.program import Signals
from xbx.bolling_up.program.Position import *
from xbx.bolling_up.program.Evaluate import *
from xbx.bolling_up.program.Function import *
from xbx.bolling_up.program.Statistics import *
...
symbol = 'ETH-USDT_5m'
para = [200, 1.5]
signal_name = 'signal_libing_2_ping_jun_cha'
rule_type = '15T'
...
drop_days = 365 * 3 + 300  # 币种刚刚上线10天内不交易


# =====读入数据
# df = pd.read_pickle(root_path + '/data/%s.pkl' % symbol)
df = pd.read_pickle('/Users/gary/workspace/quant/vnpy/xbx/coin_alpha/data/backtest/output/pickle_data/ETH-USDT_5m.pkl')
...
# 输出资金曲线文件
df_output = df[['candle_begin_time', 'open', 'high', 'low', 'close', 'signal',
                'pos', 'quote_volume', 'median', 'upper', 'lower', 'equity_curve']]
