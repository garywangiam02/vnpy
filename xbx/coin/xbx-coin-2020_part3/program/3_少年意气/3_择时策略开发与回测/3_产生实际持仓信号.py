...
# ===导入数据
df = pd.read_hdf('//root/workspace/vnpy/xbx/coin/xbx-coin-2020_part3/data/signals.h5', key='df')
...
df.to_hdf('/root/workspace/vnpy/xbx/coin/xbx-coin-2020_part3/data/pos.h5', key='df', mode='w')
