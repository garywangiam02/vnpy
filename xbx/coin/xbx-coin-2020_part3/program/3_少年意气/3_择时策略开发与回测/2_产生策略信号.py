...
# =====读入数据
symbol = 'BTC-USDT_5m'
df = pd.read_hdf('/root/workspace/vnpy/xbx/coin/xbx-coin-2020_part3/data/%s.h5' % symbol, key='df')
...
# =====将数据存入hdf文件中
df.to_hdf('/root/workspace/vnpy/xbx/coin/xbx-coin-2020_part3/data/signals.h5', key='df', mode='w')
