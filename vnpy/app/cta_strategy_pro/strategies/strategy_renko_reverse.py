...
from vnpy.component.cta_position import *
from vnpy.component.cta_policy import TNS_STATUS_OPENED, TNS_STATUS_OBSERVATE
from vnpy.component.cta_grid_trade import LOCK_GRID
from vnpy.component.cta_renko_bar import CtaRenkoBar
from vnpy.data.renko  import *
...
class Strategy_Renko_Reverse(CtaProFutureTemplate):
    ...
    def tns_add_short(self, signal):
        ...
        stop_price = sub_tns.get('stop_price', 0)
        stop_price = max(self.line_renko.line_pre_high[-1], self.line_x.line_pre_high[-1],
                         self.line_x.line_bar[-1].high_price, stop_price)
        grid = self.tns_open_from_lock(open_symbol=self.vt_symbol, open_volume=volume, grid_type=signal,
