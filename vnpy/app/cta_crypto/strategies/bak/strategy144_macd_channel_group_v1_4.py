...
########################################################################
class StrategyMacdChannelGroup_v1_4(CtaFutureTemplate):
 ...
 v1:
    ...
    def __init__(self, cta_engine,
        ...
        self.debug_dates = ['2020-09-14','2021-02-06', '2021-02-07', '2021-02-08']
    ...
    def is_macd_signal(self, kline, direction):
        ...
        if direction == Direction.LONG:
            ...
            if last_signal == 'short' \
                    ...
                    and (duan_start < cur_duan.start  or (duan_start==cur_duan.start and last_signal_time < cur_duan.bi_list[0].end)):
                ...
                if cur_duan.direction == -1 \
                    ...
                    if cur_duan.direction == -1 \
                        ...
                        if (kline.rt_macd_count > 0 or kline.cur_macd_count > 0) \
                                and kline.cur_price > min(pre_seg['max_price'], pre_seg['min_price'] + kline.bi_height_ma()):
                            d = {
                                "datetime": self.cur_datetime,
                                "price": kline.cur_price,
        ...
        if direction == Direction.SHORT:
            ...
            if open_price and last_signal and duan_start:
                ...
                if cur_duan.direction == 1 \
                    ...
                    if (kline.rt_macd_count < 0 or kline.cur_macd_count < 0) \
                            and kline.cur_price < max(pre_seg['min_price'], pre_seg['max_price'] - kline.bi_height_ma()):
                        d = {
                            "datetime": self.cur_datetime,
                            "price": kline.cur_price,
                            "operation": 'break_fail2',
