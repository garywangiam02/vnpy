...
class TripleMa_Policy(CtaPolicy):
    ...
    def from_json(self, json_data):
        ...
        self.tns_high_price = json_data.get('tns_high_price', 0)
...
class Strategy_TripleMaBinance_v2(CtaFutureTemplate):
    """15分钟级别、三均线策略
    策略：
    ...
    parameters = [
        "max_invest_percent",
        "single_lost_percent",
        "add_pos_under_price_count",
        "add_pos_above_price_count",
        "x_atr_len",
        "x_minute",
        "x_ma1_len",
        "x_ma2_len",
