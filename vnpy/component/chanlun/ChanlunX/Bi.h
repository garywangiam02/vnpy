...
void Bi1(int nCount, float *pOut, float *pIn, float *pHigh, float *pLow, int iFenXingQuJian); // 简单笔
void Bi2(int nCount, float *pOut, float *pIn, float *pHigh, float *pLow, int iFenXingQuJian); // 严格笔
