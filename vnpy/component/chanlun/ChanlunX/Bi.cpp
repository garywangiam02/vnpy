...
void Bi1(int nCount, float *pOut, float *pIn, float *pHigh, float *pLow, int iFenXingQuJian = 2)
{
    float *pDirection = new float[nCount];
    float *pOutHigh = new float[nCount];
    float *pOutLow = new float[nCount];
...
void Bi2(int nCount, float *pOut, float *pIn, float *pHigh, float *pLow, int iFenXingQuJian = 2)
{
    float *pDirection = new float[nCount];
    float *pOutHigh = new float[nCount];
    float *pOutLow = new float[nCount];
    ...
    int kCountDown = 5; // 计数K线数量，初始值假设已经向下笔第五根K线
    int kCountUp = 1;
	int minLastD = 0; // 搜索时，最小得低点索引值，放置死循环
	int minLastG = -1; // 搜索时，最小得高点索引值，放置死循环
	int loop_count = 0;
