...
test_setting['init_capital'] = 200000
...
test_setting['start_date'] = '20201101'
test_setting['init_days'] = 5
test_setting['end_date'] = '20210501'

strategy_setting = {
        f"Future_grid_tick_{symbol}_x1": {
        ...
        f"Future_grid_tick_{symbol}_x3": {
            "class_name": "StrategyGridTradeFutureV5",
            "vt_symbol": f"{vt_symbol}",
            "auto_init": True,
            "setting": {
        ...
        f"Future_grid_tick_{symbol}_x5": {
            "class_name": "StrategyGridTradeFutureV5",
            "vt_symbol": f"{vt_symbol}",
            "auto_init": True,
            "setting": {
